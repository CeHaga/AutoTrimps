var ATversion = 'CeHaga v5.1.0',
    atscript = document.getElementById('AutoTrimps-script'),
    basepath = 'https://cehaga.github.io/AutoTrimps/', //Link to your own Github here if you forked!
    modulepath = 'modules/';
...
function initializeAutoTrimps() {
    ...
    debug('AutoTrimps - CeHaga Fork Loaded!', '*spinner3');
}
...
changelogList.push({
    date: "05/06/2023",
    version: "v5.2.1",
    description: "<b>Trimps v5.9.0</b> Added limit to Balance Stacks for achievement. ",
    isNew: true
});
changelogList.push({
    date: "11/02/2023",
...
function printChangelog() {
    ...
    var footer =
        '<b>CeHaga Fork</b> - <u>Report any bugs/problems please</u>!\
        <br>Talk with the original fork dev: <b>Zek#0647</b> @ <a target="#" href="https://discord.gg/Ztcnfjr">Zeks Discord Channel</a>\
